...
<li>В папке <b>Main</b> - исходники прошивки;</li>
<li>В папке <b>ESP_BIN</b> - прошивка для ESP8266;</li>
<li>В папке <b>SOFT</b> - текущая версия конфигуратора, коннектится к контроллеру по COM-порту;</li>
