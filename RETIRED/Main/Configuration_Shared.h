...
#define MAX_RECEIVE_BUFFER_LENGTH 1024 // максимальная длина (в байтах) пакета в сети, для защиты от спама
...
//--------------------------------------------------------------------------------------------------------------------------------
#define SHARED_BUFFER_LENGTH 256 // сколько байт резервировать для общего буфера обмена
