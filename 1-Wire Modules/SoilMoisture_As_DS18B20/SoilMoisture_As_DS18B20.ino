...
#define SOIL_MOISTURE_0_PERCENT  670              // значение АЦП для 0% влажности почвы (0-1023)
#define SOIL_MOISTURE_100_PERCENT 430             // значение АЦП для 100% влажности почвы (0-1023)
...
auto ds18b20 = DS18B20(/*DS18B20::family_code*/0xA0, 0x00, 0x00, 0xB2, 0x18, 0xDA, 0x00);   // DS18B20: 9-12bit, -55 -  +85 degC
//----------------------------------------------------------------------------------------------------------------
// ||
// ||
// ||
...
#ifdef _DEBUG
	Serial.println(F("family_code: 0xA0, 0x00, 0x00, 0xB2, 0x18, 0xDA, 0x00"));
#endif
}
