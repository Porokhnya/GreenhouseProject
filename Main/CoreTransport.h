...
extern volatile bool ESPInUpdate; // флаг, что ESP внутри функции update, и нельзя из прерываний вызывать readFromStream
//--------------------------------------------------------------------------------------------------------------------------------
...
extern volatile bool SIM800InUpdate; // флаг, что SIM800 внутри функции update, и нельзя из прерываний вызывать readFromStream
//--------------------------------------------------------------------------------------------------------------------------------------
